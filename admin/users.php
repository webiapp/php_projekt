<?php 
	...
	if (isset($_POST['edit']) && $_POST['_action_'] == 'TRUE') {
		...
		$_SESSION['message'] = '<p>Uspješno ste promijenili profil korisnika!</p>';
	...
	if (isset($_GET['delete']) && $_GET['delete'] != '') {
		...
		$_SESSION['message'] = '<p>Uspješno ste izbrisali profil korisnika!</p>';
	...
	if (isset($_GET['id']) && $_GET['id'] != '') {
		...
		print '
		<p><b>zemlja:</b> ' .$_row['country_name'] . '</p>
